...
caminho_bancodedados = config.caminho_bancodedados
...
def deleta_pastas(path:str) -> str:
    """Deleta todos os arquivos dentro do caminho requisitado

    Args:
        path (str): Caminho até o diretório

    Returns:
        str: Mensagem de sucesso
    """
    
    conteudo_pasta = os.listdir(path)
...
if __name__ == '__main__':
    ...
    deleta_pastas(path=f'{config.caminho_base}/output')